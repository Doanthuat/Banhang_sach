    ...
    if (isset($_COOKIE["user"])) {
        ...
        if ($permission==1) {
            if (isset($_POST['them'])) {
                ...
                selectAll("INSERT INTO sanpham VALUES(NULL,$id_danhmuc,'$ten','$nhasanxuat','$loaimoi','$nguyenlieu','$thuonghieu',$baohanh,$xuatxu,'$bonho',$gia,'$anh1','$anh2','$anh3','$chitiet','$mota',0,1)");
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="nhasanxuat" required class="form-control text-light" placeholder="Nhập ...">
                      </div>
