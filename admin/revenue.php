          ...
          <div class="content-wrapper" style="background: #fff;">
            <div class="row">
              ...
              <div class="col-sm-4 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h5 class="addfont">Tổng Doanh Thu</h5>
                    <div class="row">
                      ...
                      <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                        <i class="icon-lg mdi mdi-monitor text-success ml-auto" style="color:#fff; display:none;"></i>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                      <i class="icon-lg mdi mdi-codepen text-primary ml-auto"style="color:#fff;  display:none;"></i>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                        <i class="icon-lg mdi mdi-wallet-travel text-danger ml-auto" style="color:#fff; display:none;"></i>
                      </div>
                    </div>
                  </div>
                </div>
