            ...
            <!-- <div class="row align-items-center "> -->
                <!-- <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="losgin_part_text_iner">
                ...
                <div class="col-lg-6 col-md-6" style="margin:auto;" style="
                    background-color: #85FFBD;
                   background-image: linear-gradient(45deg, #85FFBD 0%, #f7ff7d 100%);" >
                    <div class="login_part_form" style="padding-top:20px;background-image: linear-gradient(45deg, #85ffbd 0%, #fffb7d 100%);">            
