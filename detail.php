...
.product_description_area .nav.nav-tabs li a.active {
    box-shadow: -1.717px 8.835px 29.76px 2.24px #e9f5e8;
    ...
    <section class="product_description_area">
        <div class="container">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Chi tiết sản phẩm</a>
                </li>
                <li class="nav-item">
                            ...
                            <div class="review_box">
                                ...
                                <form class="row contact_form" action="" method="post" novalidate="novalidate">
                                    ...
                                    <div class="col-md-12 text-right">
                                        <button type="submit" name="comment" class="btn_3"  style="    box-shadow: -1.717px 8.835px 29.76px 2.24px #e9f5e8;
                                             border: 1px solid #00ff0085;
                                             background-color: #85FFBD;
                                             background-image: linear-gradient(45deg, #85FFBD 0%, #FFFB7D 100%);">Gửi</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    ...
                    ?>
                        <div class="single_product_item">
                            ...
                            <div class="single_product_text" style="background-color: transparent;">
                                <a href="detail.php?id=<?= $item['id'] ?>" >
                                <h4><?= $item['ten'] ?></h4>
