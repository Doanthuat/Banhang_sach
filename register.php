                        ...
                        ?>
                            ...
                            <?php 
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <button type="submit" name="dangky" value="submit" class="btn_3" style="    background-color: #000;  border:0px;">
                                        đăng ký
                                    </button>
                                    <!-- <a class="lost_pass" href="#">forget password?</a> -->
                                    <div class="col-md-12 form-group p_star">
                                        <a href="login.php" class="btn_3" style="text-align: center; background-color:#000; border:0px;">
                                            Quay về Đăng Nhập
                                        </a>
                                    </div>
                                </div>
